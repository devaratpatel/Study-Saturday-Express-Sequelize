...
describe("Routes", () => {
  ...
  afterEach(() => {
    return Promise.all([Student.truncate({ cascade: true }), Test.truncate({ cascade: true })]);
  });
  ...
  describe("Student Routes", () => {
    ...
    beforeEach(async () => {
      ...
      const createdStudents = await Promise.all(studentData.map((data) => Student.create(data)));
  ...
  describe.only("Test Routes", () => {
    ...
    beforeEach(async () => {
      ...
      const createdTests = await Promise.all(testData.map((data) => Test.create(data)));
